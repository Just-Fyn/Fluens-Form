    ...
    <div className="fixed inset-0 z-999 bg-black/10 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-md p-10 rounded-4xl bg-foreground flex flex-col items-center text-center shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="text-left w-full mb-8">
          ...
          <div className="mt-2 flex bg-brand-light/10 rounded-full border border-border focus-within:border-brand focus-within:shadow-[0_0_0_5px_var(--brand)]/12 overflow-hidden transition-all h-14">
            <input
              value={url}
              readOnly
  ...
  return (
    <div className="fixed inset-0 z-999 bg-black/10 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-md p-10 rounded-4xl bg-foreground flex flex-col items-center text-center shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <h2 className="font-bold text-2xl mb-6">Gagal mengirim respon</h2>
